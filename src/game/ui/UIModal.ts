...
export class UIModal {
    ...
    public showComingSoon(
        title = 'COMING SOON',
        message = 'This feature is still being prepared.\nCheck back soon!'
    ): void {
        if (this.container) {
            return;
        }
        ...
        // Clicking the backdrop also dismisses the modal, so a click that
        // lands on the overlay instead of the OK button never leaves the
        // player stuck behind it.
